...
# -*- coding: utf-8 -*-
#
# JqPyCharts documentation build configuration file..
#
...
modindex_common_prefix = ['JqPyCharts.']
...
html_logo = path_join('_static', 'JqPyCharts180_95_logo.png')
...
sidebarlogo_perpage_dict = {
   ...
   'JqPyCharts180_95_logo_bg.png': ['RequiredSoftware', 'install', 'history', 'py-modindex', 'genindex'],
}
