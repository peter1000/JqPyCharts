...
def test_jqpc_simple_bar_horizontal_chart_ok1():
   """ Tests: test_jqpc_simple_bar_horizontal_chart_ok1
   """
   print('::: TEST: test_jqpc_simple_bar_horizontal_chart_ok1()')

   scripts_bar_chart_path = path_join(SCRIPT_PATH, 'scripts_bar_chart_test_jqpc_simple_bar_horizontal_chart_ok1')
   ...
   for resource_name in [
      ...
      if resource_dir_path__abspath[-2:] == 'js':
         ...
         raise Err('test_jqpc_simple_bar_horizontal_chart_ok1', [
...
def test_jqpc_simple_bar_horizontal_chart_ok3():
   ...
   scripts_bar_chart_path = path_join(SCRIPT_PATH, 'scripts_bar_chart_test_jqpc_simple_bar_horizontal_chart_ok3')
   ...
   for resource_name in [
      ...
      if resource_dir_path__abspath[-2:] == 'js':
         ...
         raise Err('test_jqpc_simple_bar_horizontal_chart_ok3', [
            '`resource_name`: <{}> must end with <.js> or <.css>'.format(resource_name)
         ])
...
def test_jqpc_simple_bar_horizontal_chart_ok4():
   ...
   scripts_bar_chart_path = path_join(SCRIPT_PATH, 'scripts_bar_chart_test_jqpc_simple_bar_horizontal_chart_ok4')
   ...
   for resource_name in [
      ...
      if resource_dir_path__abspath[-2:] == 'js':
         ...
         raise Err('test_jqpc_simple_bar_horizontal_chart_ok4', [
            '`resource_name`: <{}> must end with <.js> or <.css>'.format(resource_name)
         ])
...
def test_jqpc_simple_bar_horizontal_chart_ok5():
   ...
   scripts_bar_chart_path = path_join(SCRIPT_PATH, 'scripts_bar_chart_test_jqpc_simple_bar_horizontal_chart_ok5')
   ...
   for resource_name in [
      ...
      if resource_dir_path__abspath[-2:] == 'js':
         ...
         raise Err('test_jqpc_simple_bar_horizontal_chart_ok5', [
            '`resource_name`: <{}> must end with <.js> or <.css>'.format(resource_name)
         ])
...
def test_jqpc_simple_bar_horizontal_chart__expect_failure1():
   ...
   for resource_name in [
      ...
      if resource_dir_path__abspath[-2:] == 'js':
         ...
         raise Err('test_jqpc_simple_bar_horizontal_chart__expect_failure1', [
            '`resource_name`: <{}> must end with <.js> or <.css>'.format(resource_name)
         ])
...
# noinspection PyPep8,PyUnusedLocal,PyUnusedLocal,PyUnusedLocal
@nose_raises(Err)
...
def test_clean_created_dirs():
   ...
   for dir_name in [
      'scripts_bar_chart_test_jqpc_simple_bar_horizontal_chart_ok1',
...
if __name__ == '__main__':
   pass
   test_jqpc_simple_bar_horizontal_chart_ok1()
   test_jqpc_simple_bar_horizontal_chart_ok2()
