...
def test_jqpc_simple_bar_chart_ok3():
   """ Tests: test_jqpc_simple_bar_chart_ok3: chart_x_label
   """
...
def test_jqpc_simple_bar_chart_ok4():
   """ Tests: test_jqpc_simple_bar_chart_ok4: chart_x_label_fontdict
   """
...
def test_jqpc_simple_bar_chart_ok5():
   """ Tests: test_jqpc_simple_bar_chart_ok5: chart_ticks_fontdict
   """
...
@nose_raises(Err)
def test_jqpc_simple_bar_chart__expect_failure2():
   """ Tests: test_jqpc_simple_bar_chart__expect_failure2: test_jqpc_simple_bar_chart__expect_failure2
   """
   print('::: TEST: test_jqpc_simple_bar_chart__expect_failure2()')

   scripts_bar_chart_path = path_join(SCRIPT_PATH, 'scripts_pie_chart_test_jqpc_simple_bar_chart__expect_failure2')
   ...
   for resource_name in [
      ...
      if resource_dir_path__abspath[-2:] == 'js':
         ...
         raise Err('test_jqpc_simple_bar_chart__expect_failure2', [
            '`resource_name`: <{}> must end with <.js> or <.css>'.format(resource_name)
         ])
...
def test_clean_created_dirs():
   ...
   for dir_name in [
      ...
      'scripts_bar_chart_test_jqpc_simple_bar_chart__expect_failure2',
   ]:
...
if __name__ == '__main__':
   ...
   test_jqpc_simple_bar_chart__expect_failure2()
